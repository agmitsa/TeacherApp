...
@WebServlet("/studentcoursedelete")
...
public class DeleteStudentCourseController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			studentCourseServ.delete(studentCourseDTO);
			request.setAttribute("studentcoursedeleted", true);
			...
			request.setAttribute("deleteStudentCourseError", true);
