...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #545e66;">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mb-2 mb-lg-0 ">
          ...
          <li class="nav-item">
            <a class="nav-link" href="${pageContext.request.contextPath}/jsps/teachersmenu.jsp">Students menu</a>
          </li>
          <li class="nav-item">
	...
	<div class="col-md-6 mt-5 mx-auto">
		...
		<div class="update-wrapper bg-white p-5 pt-4 border border-secondary rounded">
			...
			<form method="POST" action="${pageContext.request.contextPath}/teacherupdate">
			  <div class="row">
				<input  type="hidden" name="id" id="id" value="${teacher.id}" required autofocus/>
			    <div class="form-group col p-2">
			      <input type="text" class="form-control" name="firstname" id="firstname" 
			      value="${teacher.firstname}" placeholder="Update teacher's firstname" required>
			    </div>
			    <div class="form-group col p-2">
			      <input type="text" class="form-control"  name="lastname" id="lastname"  
			     placeholder="Update teacher's firstname" value="${teacher.lastname}" required>
			    </div>
			    
			  </div>
			  <button type="submit" class="btn btn-success col-md-3 float-right">Update Teacher</button>
			</form>
