...
<body>
	...
	<div class="col-md-6 mt-5 mx-auto">
		<div class="update-wrapper bg-white p-5 pt-4 border border-secondary rounded">
			...
			<form method="POST" action="${pageContext.request.contextPath}/courseupdate">
			  <div class="row">
				<input  type="hidden" name="id" id="id" value="${course.id}" required autofocus/>
			    <div class="form-group col p-2">
			      <input type="text" class="form-control" name="description" id="description" 
			      value="${course.description}" placeholder="Update course description" required>
			    </div>
			    <div class="form-group col p-2">
			      <input type="text" class="form-control"  name="teacherid" id="teacherid"  
			     placeholder="Update course's teacherid" value="${course.teacherid}" required>
			    </div>
			    
			  </div>
			  <button type="submit" class="btn btn-success col-md-3 float-right">Update course</button>
			</form>
