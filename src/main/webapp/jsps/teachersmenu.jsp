...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #545e66;">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mb-2 mb-lg-0 ">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="${pageContext.request.contextPath}/jsps/teachersmenu.jsp">Teachers menu</a>
          </li>
          <li class="nav-item">
	...
	<div class="center col-md-10 mx-auto mt-5">	
		<div class="search-wrapper bg-white col-md-4 mx-auto mb-4 p-4 border border-secondary rounded">
			...
			<h2 class="text-center mb-3">Search Teacher</h2>
			<form class="form-inline" method="GET" action="${pageContext.request.contextPath}/teachersearch">
			...
			<form class="form-inline" method="GET" action="${pageContext.request.contextPath}/searchteacherbyid">
			  <div class="form-group d-inline-flex p-3 mx-sm-3 mb-2">
			    <input type="text" class="form-control" name="id" id="id" placeholder="Search by teacher id" required>   
			  </div>
			  <input type="submit" class="btn btn-secondary mb-2" value="Search">
			</form>	
		...
		<div class="insert-wrapper bg-white col-md-6 mx-auto p-5 pt-4 border border-secondary rounded">
			...
			<form method="POST" action="${pageContext.request.contextPath}/teacherinsert">
			  <div class="row">
			
			    <div class="form-group col p-2">
			      <label for="description">Teacher Firstname</label><br/>    
			      <input type="text" class="form-control" name="firstname" id="firstname" required>
			    </div>
			    <div class="form-group col p-2">
			      <label for="teacherid">Teacher Lastname</label>			    
